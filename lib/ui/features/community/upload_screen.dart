    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Share your music with the VibeRadar community. DJs and listeners will discover your tracks.',
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: AppTheme.glass(
                    radius: AppTheme.rMd,
                    tint: AppTheme.amber,
                    border: AppTheme.amber.withValues(alpha: 0.25),
                    raised: false,
                  ),
                  child: InkWell(
                    onTap: () =>
                ...
                GradientButton(
                  ...
                  label: _uploading ? 'Uploading...' : 'Upload to Community',
                  onPressed:
                      _uploading ||
                          _audioPath == null ||
    ...
    if (result != null && result.files.isNotEmpty) {
      setState(() {
        ...
        if (_titleController.text.isEmpty) {
          final name = result.files.first.name.replaceAll(
            RegExp(r'\.[^.]+$'),
            '',
          );
    ...
    try {
      ...
      if (mounted) {
        ...
        ref
            ...
            .setSection(AppSection.community);
      }
    } catch (e) {
      setState(() {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  fileName.isNotEmpty ? fileName : hint,
                  style: TextStyle(
