              ...
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(a.name, style: const TextStyle(color: AppTheme.textPrimary, fontWeight: FontWeight.w600, fontSize: 14), maxLines: 1, overflow: TextOverflow.ellipsis),
                    const SizedBox(height: 4),
                    Text(a.genre, style: const TextStyle(color: AppTheme.textSecondary, fontSize: 12), maxLines: 1, overflow: TextOverflow.ellipsis),
                    const SizedBox(height: 4),
                    Text('${a.listeners} listeners', style: const TextStyle(color: AppTheme.textSecondary, fontSize: 11)),
                    const Spacer(),
                    Row(
                      children: [
                        Container(
                          ...
                          child: Text(a.country, style: const TextStyle(color: AppTheme.textPrimary, fontSize: 10, fontWeight: FontWeight.w600)),
                        ),
                        const Spacer(),
